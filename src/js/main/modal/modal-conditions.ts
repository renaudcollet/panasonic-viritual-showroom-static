...
export default class ModalConditions extends ModalBase {
  ...
  onOpening() {
    ...
    if (window.matchMedia(`(min-width: ${Constants.lg}px)`).matches) {
      const _scroller: any = document.querySelector('.modal-conditions .scroller') || null
      if (_scroller) {
    ...
    window.dataLayer.push({
      ...
      eventAction: 'Main',
      eventLabel: 'Conditions'  // name of the clicked navigation item 
    })
  }
